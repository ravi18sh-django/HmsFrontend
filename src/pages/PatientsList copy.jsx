...
function PatientsList() {
    ...
    const columns = useMemo(
        () => [
                    ...
                    <div className="flex space-x-3">
                        ...
                        <button 
                            onClick={() => {
                                ...
                                deletePatient(row.original._id)
                            }}
            ...
            { header: "Doctor", accessorKey: "doctor.name" },
            { header: "Clinic", accessorKey: "clinic.name" },
        ],
        []
    );
    ...
    const table = useReactTable({
        ...
        initialState: { pagination: { pageSize: 10 } }, // Show 10 rows per page
    });
